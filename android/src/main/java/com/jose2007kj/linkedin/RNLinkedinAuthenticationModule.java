 ...
 *
 */
public class RNLinkedinAuthenticationModule extends ReactContextBaseJavaModule implements ActivityEventListener {

    // TAG!
    public static final String TAG = RNLinkedinAuthenticationModule.class.getCanonicalName();
     ...
     */
    public RNLinkedinAuthenticationModule(final ReactApplicationContext reactContext) {
